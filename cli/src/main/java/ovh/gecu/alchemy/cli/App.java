package ovh.gecu.alchemy.cli;

import ovh.gecu.alchemy.core.reactor.ReactorCoordinator;
import ovh.gecu.alchemy.core.reactor.Reactor;
...
import ovh.gecu.alchemy.parser.CellParser;
import ovh.gecu.alchemy.parser.InvalidSyntaxException;
...
public class App implements Callable<Boolean> {
   ...
   * The logging rate is slowed using a {@link SleepFilter}.
   * The value is set by the PicoCLI framework.
   */
